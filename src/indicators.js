...
export const buildFeatures = candles => {
  ...
  features.impulse = features.fastImpulse || features.steadyImpulse;
  features.setupType = features.fastImpulse ? 'FAST_BREAKOUT' : features.steadyImpulse ? 'STEADY_MOMENTUM' : null;
  ...
  features.setupScore = features.setupType === 'STEADY_MOMENTUM' ? steadyScore : fastScore;
