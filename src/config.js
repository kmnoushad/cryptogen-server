...
export const loadConfig = (env = process.env) => {
  ...
  const cfg = {
    ...
    maxEntryQuoteAgeMs: numberFrom(env, 'MAX_ENTRY_QUOTE_AGE_MS', 5_000, { min: 1_000, max: 15_000 }),
    manualEntryTtlSec: numberFrom(env, 'MANUAL_ENTRY_TTL_SEC', 30, { min: 5, max: 60 }),
