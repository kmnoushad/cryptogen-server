# NEXIO v6.7 — Restored Liquid Futures Path, Monitored Exits + Live Macro Calendar
...
4. Deploy with Node 20 or newer. No npm packages are required. Upgrading from v6.4–v6.6 requires no new SQL and no new Railway variables.
