# NEXIO v6.8.1 — Candidate Survival + Realtime BTC Shock Protection
...
4. Deploy with Node 20 or newer. Railway installs the locked `ws` dependency from `package-lock.json`. Upgrading from v6.4–v6.8 requires no new SQL and no required new Railway variables; all safety variables have defaults.
