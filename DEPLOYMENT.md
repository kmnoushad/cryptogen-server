...
2. Existing v6.1–v6.3 installation: run `sql/v6.4-migration.sql` in the Supabase SQL editor. New installation: run `sql/schema.sql`.
...
4. Send `/version`, `/status`, `/diagnostics`, then `/scan` to the bot. `/version` must report `v6.4.0`.
